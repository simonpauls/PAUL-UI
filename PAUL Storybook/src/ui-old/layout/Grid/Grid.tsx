...
export function Grid({
  ...
  const gridStyle: CSSProperties = {
    ...
    gap: gap ? `var(--paul-size-space-${gap})` : undefined,
    columnGap: columnGap ? `var(--paul-size-space-${columnGap})` : undefined,
    rowGap: rowGap ? `var(--paul-size-space-${rowGap})` : undefined,
    justifyItems,
    alignItems,
  };
