    ...
    <Section padding={sectionPadding} variant="neutral">
      <Flex container direction="column" alignSecondary="stretch" gap={flexGap}>
        ...
        <Flex container type="third" alignPrimary="center">
          <FlexItem size="major">
            <Accordion>
              <AccordionItem title="What is Simple Design System (PAUL)?">
                PAUL is a React-based design system that provides accessible,
                production-ready UI components, design tokens, and Figma
                integration for demonstrating how to build consistent user
                interfaces efficiently.
              </AccordionItem>
              <AccordionItem title="How do I install PAUL in my project?">
                It is not distributed yet, but you can use it directly, by
                cloning the repository at{" "}
                <a href="https://github.com/figma/paul">github.com/figma/paul</a>.
                Refer to the documentation for setup instructions and usage
                examples.
              </AccordionItem>
              <AccordionItem title="Does PAUL support dark mode?">
                Yes, PAUL includes full support for light and dark modes using
              ...
              <AccordionItem title="Where can I find component documentation?">
                ...
                the Storybook at{" "}
                <a href="https://figma.github.io/paul/storybook">
                  figma.github.io/paul/storybook
                </a>
                .
              </AccordionItem>
            </Accordion>
