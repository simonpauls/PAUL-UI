...
const NAMESPACE = "com.figma.paul";
// Prefix for CSS custom properties
const TOKEN_PREFIX = "paul-";
...
async function initialize() {
  ...
  console.log(processed.color.definitions.paul_light);
